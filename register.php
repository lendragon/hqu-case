...
<body>
    <div id="main">
        ...
        <div class="main_bottom">
            <div class="login">
                <form method="post" action="index_sql.php?opera=0">
                    ...
                    <input name="i_code" type="text" placeholder="请输入验证码"/>
                    ...
                    <div class="other">
                        <a href="index.php">已有账号，立即登录</a>
                    </div>

                    <hr/>

                    <button type="submit" name="Submit" id="sub" >立即注册</button>
                </form>
            </div>
        </div>
